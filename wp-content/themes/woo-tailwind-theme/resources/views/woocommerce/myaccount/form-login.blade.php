...
<section class="px-4 md:px-14 w-full min-h-screen flex items-center justify-center bg-cover bg-center" 
    ...
    <div class="bg-transparent w-full max-w-md">
        {{-- Formulario de Login --}}
        <div id="loginForm" class="form-container visible-form bg-black/60 p-8 rounded-[50px] shadow-lg text-gray-200 border-4 border-orange-500">
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post">
                ...
                <div class="space-y-4 mb-4">
                    <div>
                        <label for="username" class="block text-base font-bold mb-2">NOMBRE DE USUARIO O CORREO ELECTRÓNICO</label>
                        <input type="text" class="form-input" 
                               name="username" id="username" autocomplete="username" value="{{ old('username') }}" required>
                    </div>

                    <div>
                        <label for="password" class="block text-base font-bold mb-2">CONTRASEÑA</label>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ wp_lostpassword_url() }}" class="text-orange-400 hover:text-orange-300 text-sm font-bold">
                ...
                <button type="button" onclick="showRegisterForm()"
                        class="switch-button w-full p-3 rounded-full text-lg font-bold mt-4">
        ...
        @if(get_option('woocommerce_enable_myaccount_registration') === 'yes')
        <div id="registerForm" class="form-container hidden-form bg-black/60 p-8 rounded-[50px] shadow-lg text-gray-200 border-4 border-orange-500">
            <h2 class="text-4xl font-bold mb-6 text-center">CREA UNA CUENTA</h2>
            ...
            <form method="post" class="woocommerce-form woocommerce-form-register register">
                ...
                <div class="space-y-4 mb-4">
                    ...
                    <div>
                        <label for="reg_username" class="block text-base font-bold mb-2">NOMBRE DE USUARIO</label>
                        <input type="text" class="form-input" 
                    ...
                    <div>
                        <label for="reg_email" class="block text-base font-bold mb-2">CORREO ELECTRÓNICO</label>
                    ...
                    <div>
                        <label for="reg_password" class="block text-base font-bold mb-2">CONTRASEÑA</label>
                        <input type="password" class="form-input" 
                               name="password" id="reg_password" autocomplete="new-password" required>
                        <p class="text-sm text-gray-400 mt-1">Mínimo 8 caracteres con letras y números.</p>
                    </div>
                    @else
