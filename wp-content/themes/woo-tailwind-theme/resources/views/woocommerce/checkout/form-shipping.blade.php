            ...
            <h3 id="ship-to-different-address" class="flex items-center">
                <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox flex items-center cursor-pointer">
                    <input id="ship-to-different-address-checkbox" 
                           class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-3" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.innerWidth < 768) {
        const shippingFields = document.querySelectorAll('.woocommerce-shipping-fields__field-wrapper input, .woocommerce-shipping-fields__field-wrapper select');
